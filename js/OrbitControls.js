...
THREE.OrbitControls = function ( object, domElement ) {
	...
	this.getrotateSpeed = function() {
		var altitude = scope.object.position.distanceTo( new THREE.Vector3(0,0,0) ) - 0.5;

		return scope.rotateSpeed * (1 * altitude / 1.5)
	}
	...
	function getZoomScale() {
		...
		return Math.pow( 0.95, scope.zoomSpeed * (altitude / 1.5) );
	...
	function handleMouseMoveRotate( event ) {
		...
		rotateLeft( 2 * Math.PI * rotateDelta.x / element.clientWidth * scope.getrotateSpeed() );

		// rotating up and down along whole screen attempts to go 360, but limited to 180
		rotateUp( 2 * Math.PI * rotateDelta.y / element.clientHeight * scope.getrotateSpeed() );
